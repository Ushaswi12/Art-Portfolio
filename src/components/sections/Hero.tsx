        ...
        <div className="container-custom relative z-20 pt-20 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-[56rem]">
            <div className="section-header">
              ...
              <h1 id="hero-title" className="font-display font-light text-[clamp(3.5rem,8vw,8rem)] text-[var(--color-text)] leading-tight mb-6">
                {pageContent.hero.headline}
              </h1>
              <p className="section-subtitle max-w-[36rem] mb-10">{pageContent.hero.headline}</p>
            </div>
