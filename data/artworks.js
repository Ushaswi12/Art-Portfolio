...
export const categories = ['All', 'Paintings', 'Sketches', 'Portraits', 'Traditional Art', 'Watercolor', 'Acrylic', 'DIY Crafts', 'Mini Crafts', 'Handmade Decor', 'Canvas Paintings', 'Fan Art'];
