...
export default function LatestInstagramWorks() {
  ...
  if (!mounted) {
    return (
      <section id="latest-works" className="section bg-surface" aria-hidden="true">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            ...
            <a
              ...
              className="btn-secondary inline-flex self-end md:self-auto"
            >
              Follow @ushaswi_014
  ...
  return (
    <section id="latest-works" className="section bg-surface" suppressHydrationWarning>
      <div className="container-custom">
        <motion.div
        ...
        <motion.div
          ...
          role="list"
          aria-label="Latest Instagram works"
